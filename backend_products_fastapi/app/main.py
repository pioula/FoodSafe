...
def get_database(uid):
   ...
   CONNECTION_STRING = "mongodb://fridge:pass@mongo-0.mongo-svc:27017/?authSource=admin"
   a = uid[0]
   if a.islower() or (a.isnumeric() and a <= '4'):
    CONNECTION_STRING = "mongodb://fridge:pass@mongo-1.mongo-svc:27017/?authSource=admin"
